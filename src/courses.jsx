...
class Courses extends Component {
  ...
  constructor(props) {
    ...
    updateCourse(name) {
      ...
      this.setState({catName: name.target.value});
    }
    ...
    categoryCheck(category, catName){
      var check = false;
      if(catName) {
        if(category === catName) {
          check = true;
    ...
    render() {
        ...
        return (
          <div className="wrapper">
            ...
            <Sidebar ref={this.sidebarElement} setCategory={this.updateCourse} setInput={this.updateSearch}></Sidebar>
            <main className="main">
              ...
              <div className="courses-main">
              {
                ...
                categoryCheck = this.categoryCheck(course.category, this.state.catName);
                if(categoryCheck === true && searchCheck === true) {
